...
const TermsAndConditions = () => {
  const sections = [
    { title: "Introduction", content: "Welcome to Durra website. By accessing or using the services offered here, you agree to comply with and be bound by these terms and conditions." },
    ...
    { title: "Privacy & Security", content: "Durra respects your privacy. Any personal information collected is protected under our Privacy Policy." },
    { title: "Limitation of Liability", content: "Durra are not liable for any indirect or consequential losses arising from the use of our website or products." },
    ...
    <div className="tc-page">
      <div className="tc-container">
        ...
        <section className="tc-hero">
          <h1 className="tc-hero-title">Terms and Conditions</h1>
